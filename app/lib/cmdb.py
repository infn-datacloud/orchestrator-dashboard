...
class Cmdb:
    ...
    def get_service(self, access_token, service_id):
        ...
        url = path_utils.url_path_join(self.url, "/service/id/", service_id)
    ...
    def get_services(self, access_token, provider=None):
        ...
        if provider:
            url = path_utils.url_path_join(self.url, f"/provider/id/{provider}/has_many/services")
        else:
            url = path_utils.url_path_join(self.url, "/service/list")
    ...
    def get_service_projects(self, access_token, service_id):
        ...
        url = path_utils.url_path_join(self.url, "/service/id/", service_id, "/has_many/tenants")
        response = requests.get(url, headers=headers, timeout=self.timeout)
        response.raise_for_status()
