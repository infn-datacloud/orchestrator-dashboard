...
DASHBOARD_CONF_DIR = "/opt/dashboard-configuration"
TOSCA_PARAMETERS_DIR = "{}/tosca-parameters".format(DASHBOARD_CONF_DIR)
TOSCA_METADATA_DIR = "{}/tosca-metadata".format(DASHBOARD_CONF_DIR)
